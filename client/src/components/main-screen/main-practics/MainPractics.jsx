              ...
              <div className={s.animated_slideInUp}>
                <div className={s.features_item}>
                    ...
                    <div className={s.main}>
                      ...
                      Мы используем в упражнениях базы данных, приближенные к реальным, затрагиваем большинство операторов и выражений, которые могут пригодиться вам в дальнейшей работе.
                      </div>
                    </div>
